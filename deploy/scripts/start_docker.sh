...
docker pull 957417441966.dkr.ecr.ap-south-1.amazonaws.com/spotify_hybrid_recsys:latest
...
docker run -d -p 8000:8000 --name hybrid_recsys 957417441966.dkr.ecr.ap-south-1.amazonaws.com/spotify_hybrid_recsys:latest
